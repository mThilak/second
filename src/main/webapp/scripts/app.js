...
var secondApp = angular.module('secondApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'secondAppUtils', 'pascalprecht.translate', 'truncate']);
